...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center dental-hero-gradient relative overflow-hidden">
      ...
      <div className="absolute top-20 right-20 w-32 h-32 bg-white/20 rounded-full blur-xl animate-float"></div>
      <div className="absolute bottom-20 left-20 w-24 h-24 bg-accent/30 rounded-full blur-lg animate-float" style={{animationDelay: '1s'}}></div>
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-4xl mx-auto animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed">
            Tratamientos odontológicos de última generación con los mejores especialistas. 
            Recupera la confianza en tu sonrisa con nosotros.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 animate-slide-up">
          <div className="bg-white/20 backdrop-blur-sm rounded-xl p-6 hover-lift">
            <div className="text-3xl font-bold text-white mb-2">+500</div>
            <div className="text-white/80">Pacientes Satisfechos</div>
          </div>
          <div className="bg-white/20 backdrop-blur-sm rounded-xl p-6 hover-lift">
          ...
          <div className="bg-white/20 backdrop-blur-sm rounded-xl p-6 hover-lift">
            ...
            <div className="text-white/80">Garantía de Calidad</div>
          </div>
        </div>
      </div>
    </section>
